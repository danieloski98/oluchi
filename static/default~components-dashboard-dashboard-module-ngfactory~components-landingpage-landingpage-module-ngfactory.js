(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~components-dashboard-dashboard-module-ngfactory~components-landingpage-landingpage-module-ngfactory"],{
...
class UserStateService {
    constructor() {
        this.pageTitleClone = new rxjs__WEBPACK_IMPORTED_MODULE_0__["BehaviorSubject"]('Dashboard');
        this.pageTitle = this.pageTitleClone.asObservable();
        this.userClone = new rxjs__WEBPACK_IMPORTED_MODULE_0__["BehaviorSubject"]({});
        this.user = this.userClone.asObservable();
        this.passwordClone = new rxjs__WEBPACK_IMPORTED_MODULE_0__["BehaviorSubject"]('');
        this.passwordHolder = this.passwordClone.asObservable;
    }
    changeTitle(title) {
    ...
    get getUser() {
        return Object(rxjs__WEBPACK_IMPORTED_MODULE_0__["of"])(this.user);
    }
    updatePassword(value) {
        this.passwordClone.next(value);
    }
}
UserStateService.ngInjectableDef = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjectable"]({ factory: function UserStateService_Factory() { return new UserStateService(); }, token: UserStateService, providedIn: "root" });


/***/ })

}]);
//# sourceMappingURL=default~components-dashboard-dashboard-module-ngfactory~components-landingpage-landingpage-module-ngfactory.js.map